...
import pokeys.mod.reborn.procedures.CookedImprovisedcakeconsumedizzychanceProcedureProcedure;
...
public class CookedimprovisedcakeItem extends Item {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.literal("you caught on that the meat was raw yay!"));
	}

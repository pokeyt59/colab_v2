...
public abstract class CookedpotatoarmorItem extends ArmorItem {
	public CookedpotatoarmorItem(EquipmentSlot slot, Item.Properties properties) {
		super(new ArmorMaterial() {
			...
			public SoundEvent getEquipSound() {
				return ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("pokey_mod_reborn:clasic_legacy_sounds"));
			}
	...
	public static class Helmet extends CookedpotatoarmorItem {
		...
		public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
			...
			list.add(Component.literal("smells tasty but don't eat"));
		}

		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "pokey_mod_reborn:textures/models/armor/cooked_potato__layer_1.png";
		}
	}
	...
	public static class Leggings extends CookedpotatoarmorItem {
		...
		public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
			super.appendHoverText(itemstack, world, list, flag);
			list.add(Component.literal("smells tasty but don't eat like really"));
		}

		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "pokey_mod_reborn:textures/models/armor/cooked_potato__layer_2.png";
		}
	}

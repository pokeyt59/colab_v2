...
import pokeys.mod.reborn.procedures.Hot_handsProcedure;
...
public abstract class LuminisomArmorItem extends ArmorItem {
		...
		super(new ArmorMaterial() {
			...
			public Ingredient getRepairIngredient() {
				return Ingredient.of(new ItemStack(PokeyModRebornModItems.LUMINISOM_INGOT.get()),
						new ItemStack(PokeyModRebornModBlocks.LUMINISOM_BLOCK.get()));
			}
	...
	public static class Helmet extends LuminisomArmorItem {
		public Helmet() {
			super(EquipmentSlot.HEAD, new Item.Properties().tab(PokeyModRebornModTabs.TAB_P_AMOD).fireResistant());
		}

		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "pokey_mod_reborn:textures/models/armor/luminisom_layer_1.png";
		}
	...
	public static class Leggings extends LuminisomArmorItem {
		public Leggings() {
			super(EquipmentSlot.LEGS, new Item.Properties().tab(PokeyModRebornModTabs.TAB_P_AMOD).fireResistant());
		}

		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "pokey_mod_reborn:textures/models/armor/luminisom_layer_2.png";
		}
	...
	public static class Boots extends LuminisomArmorItem {
		public Boots() {
			super(EquipmentSlot.FEET, new Item.Properties().tab(PokeyModRebornModTabs.TAB_P_AMOD).fireResistant());
		}

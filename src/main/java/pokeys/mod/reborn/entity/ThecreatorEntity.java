...
public class ThecreatorEntity extends Monster implements RangedAttackMob {
	...
	public ThecreatorEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(PokeyModRebornModEntities.THECREATOR.get(), world);
	}
	...
	public ThecreatorEntity(EntityType<ThecreatorEntity> type, Level world) {
		...
		xpReward = 1000;
		setNoAi(false);
		setCustomName(Component.literal("the main creator"));
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(PokeyModRebornModItems.REINFORCEDTUNGSTENINGOT.get()));
	}
	...
	public void performRangedAttack(LivingEntity target, float flval) {
		ThecreatorEntityProjectile entityarrow = new ThecreatorEntityProjectile(PokeyModRebornModEntities.THECREATOR_PROJECTILE.get(), this,
				this.level);
	...
	public static void init() {
		SpawnPlacements.register(PokeyModRebornModEntities.THECREATOR.get(), SpawnPlacements.Type.ON_GROUND,

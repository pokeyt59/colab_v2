...
public class LuminisomOreFeature extends OreFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("pokey_mod_reborn:luminisom_ore", FEATURE,
				new OreConfiguration(List.of(OreConfiguration.target(new BlockStateMatchTest(Blocks.STONE.defaultBlockState()),
						PokeyModRebornModBlocks.LUMINISOM_ORE.get().defaultBlockState())), 3));
		PLACED_FEATURE = PlacementUtils.register("pokey_mod_reborn:luminisom_ore", CONFIGURED_FEATURE,

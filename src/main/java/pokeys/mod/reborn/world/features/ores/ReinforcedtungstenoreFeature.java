...
package pokeys.mod.reborn.world.features.ores;
...
public class ReinforcedtungstenoreFeature extends OreFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("pokey_mod_reborn:reinforcedtungstenore", FEATURE,
				new OreConfiguration(List.of(OreConfiguration.target(new BlockStateMatchTest(Blocks.STONE.defaultBlockState()),
						PokeyModRebornModBlocks.REINFORCEDTUNGSTENORE.get().defaultBlockState())), 3));
		PLACED_FEATURE = PlacementUtils.register("pokey_mod_reborn:reinforcedtungstenore", CONFIGURED_FEATURE,

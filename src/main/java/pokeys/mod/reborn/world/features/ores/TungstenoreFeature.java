...
public class TungstenoreFeature extends OreFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("pokey_mod_reborn:tungstenore", FEATURE,
				new OreConfiguration(List.of(OreConfiguration.target(new BlockStateMatchTest(Blocks.STONE.defaultBlockState()),
						PokeyModRebornModBlocks.TUNGSTENORE.get().defaultBlockState())), 7));
		PLACED_FEATURE = PlacementUtils.register("pokey_mod_reborn:tungstenore", CONFIGURED_FEATURE,

...
public class RiceplantFeature extends RandomPatchFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("pokey_mod_reborn:riceplant", FEATURE,
				FeatureUtils.simpleRandomPatchConfiguration(64,
						PlacementUtils.filtered(Feature.BLOCK_COLUMN,
								BlockColumnConfiguration.simple(BiasedToBottomInt.of(2, 4),
										BlockStateProvider.simple(PokeyModRebornModBlocks.RICEPLANT.get())),
								BlockPredicate.allOf(BlockPredicate.ONLY_IN_AIR_PREDICATE,
										BlockPredicate.wouldSurvive(PokeyModRebornModBlocks.RICEPLANT.get().defaultBlockState(), BlockPos.ZERO)))));
		PLACED_FEATURE = PlacementUtils.register("pokey_mod_reborn:riceplant", CONFIGURED_FEATURE, List.of(CountPlacement.of(5),

package pokeys.mod.reborn.client.model;
...
public class Modelpokeythecreator<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("pokey_mod_reborn", "modelpokeythecreator"),
			"main");

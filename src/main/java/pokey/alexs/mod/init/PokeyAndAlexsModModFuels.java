...
public class PokeyAndAlexsModModFuels {
	...
	public static void furnaceFuelBurnTimeEvent(FurnaceFuelBurnTimeEvent event) {
		...
		if (itemstack.getItem() == PokeyAndAlexsModModItems.WOODLOGARMOR_HELMET.get())
			event.setBurnTime(1600);
		else if (itemstack.getItem() == PokeyAndAlexsModModItems.WOODLOGARMOR_CHESTPLATE.get())
			event.setBurnTime(6000);
		else if (itemstack.getItem() == PokeyAndAlexsModModItems.WOODLOGARMOR_LEGGINGS.get())
			event.setBurnTime(3000);
		else if (itemstack.getItem() == PokeyAndAlexsModModItems.WOODLOGARMOR_BOOTS.get())
			event.setBurnTime(3000);
		else if (itemstack.getItem() == PokeyAndAlexsModModItems.LEAFYARMOR_HELMET.get())
			event.setBurnTime(1650);
		else if (itemstack.getItem() == PokeyAndAlexsModModItems.LEAFYARMOR_CHESTPLATE.get())
			event.setBurnTime(5000);
		else if (itemstack.getItem() == PokeyAndAlexsModModItems.LEAFYARMOR_LEGGINGS.get())
			event.setBurnTime(4940);
		else if (itemstack.getItem() == PokeyAndAlexsModModItems.LEAFYARMOR_BOOTS.get())

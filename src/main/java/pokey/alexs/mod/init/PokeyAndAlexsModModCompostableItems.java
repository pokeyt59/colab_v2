...
public class PokeyAndAlexsModModCompostableItems {
	...
	public static void addComposterItems(FMLCommonSetupEvent event) {
		ComposterBlock.COMPOSTABLES.put(PokeyAndAlexsModModItems.WOODLOGARMOR_HELMET.get(), 1f);
		ComposterBlock.COMPOSTABLES.put(PokeyAndAlexsModModItems.WOODLOGARMOR_CHESTPLATE.get(), 1f);
		ComposterBlock.COMPOSTABLES.put(PokeyAndAlexsModModItems.WOODLOGARMOR_LEGGINGS.get(), 1f);
		ComposterBlock.COMPOSTABLES.put(PokeyAndAlexsModModItems.WOODLOGARMOR_BOOTS.get(), 1f);
		ComposterBlock.COMPOSTABLES.put(PokeyAndAlexsModModItems.LEAFYARMOR_LEGGINGS.get(), 1f);

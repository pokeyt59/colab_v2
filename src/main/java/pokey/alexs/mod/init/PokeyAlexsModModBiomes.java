...
import pokey.alexs.mod.world.biome.ThecreatorsdenBiome;
import pokey.alexs.mod.world.biome.ErsmBiome;
...
public class PokeyAlexsModModBiomes {
	public static final DeferredRegister<Biome> REGISTRY = DeferredRegister.create(ForgeRegistries.BIOMES, PokeyAlexsModMod.MODID);
					...
					if (currentRuleSource instanceof SurfaceRules.SequenceRuleSource sequenceRuleSource) {
						...
						surfaceRules.add(1,
								anySurfaceRule(ResourceKey.create(Registry.BIOME_REGISTRY, THECREATORSDEN.getId()),
										PokeyAlexsModModBlocks.REINFORCEDTUNGSTENORE.get().defaultBlockState(),
										PokeyAlexsModModBlocks.TUNGSTENORE.get().defaultBlockState(),
										PokeyAlexsModModBlocks.LUMINISOM_BLOCK.get().defaultBlockState()));
						surfaceRules.add(1,
								preliminarySurfaceRule(ResourceKey.create(Registry.BIOME_REGISTRY, ERSM.getId()),
										PokeyAlexsModModBlocks.SALTORE.get().defaultBlockState(), Blocks.EMERALD_ORE.defaultBlockState(),

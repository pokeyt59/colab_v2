...
public class ThecreatorEntity extends Monster implements RangedAttackMob {
	private static final Set<ResourceLocation> SPAWN_BIOMES = Set.of(new ResourceLocation("pokey_alex_mod:thecreatorsden"));
	...
	public ThecreatorEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(PokeyAlexModModEntities.THECREATOR.get(), world);
	}
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(PokeyAlexModModItems.REINFORCEDTUNGSTENINGOT.get()));
	}
	...
	public void performRangedAttack(LivingEntity target, float flval) {
		ThecreatorEntityProjectile entityarrow = new ThecreatorEntityProjectile(PokeyAlexModModEntities.THECREATOR_PROJECTILE.get(), this,
				this.level);
	...
	public static void init() {
		SpawnPlacements.register(PokeyAlexModModEntities.THECREATOR.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
	...
	public static AttributeSupplier.Builder createAttributes() {
		...
		builder = builder.add(Attributes.ATTACK_KNOCKBACK, 2.6);
		return builder;
	}
}

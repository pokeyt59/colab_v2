...
import pokey.alex.mod.procedures.Light_as_a_featherProcedure;
...
public abstract class LighttungstenarmorItem extends ArmorItem {
	...
	public static class Helmet extends LighttungstenarmorItem {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "pokey_alex_mod:textures/models/armor/light_tungsten_armor_layer_1.png";
		}
	...
	public static class Leggings extends LighttungstenarmorItem {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "pokey_alex_mod:textures/models/armor/light_tungsten_armor_layer_2.png";
		}

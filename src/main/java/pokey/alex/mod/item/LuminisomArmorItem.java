...
import pokey.alex.mod.procedures.Hot_handsProcedure;
...
public abstract class LuminisomArmorItem extends ArmorItem {
		...
		super(new ArmorMaterial() {
			...
			public Ingredient getRepairIngredient() {
				return Ingredient.of(new ItemStack(PokeyAlexModModItems.LUMINISOM_INGOT.get()),
						new ItemStack(PokeyAlexModModBlocks.LUMINISOM_BLOCK.get()));
			}
	...
	public static class Helmet extends LuminisomArmorItem {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "pokey_alex_mod:textures/models/armor/luminisom_layer_1.png";
		}
	...
	public static class Leggings extends LuminisomArmorItem {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "pokey_alex_mod:textures/models/armor/luminisom_layer_2.png";
		}

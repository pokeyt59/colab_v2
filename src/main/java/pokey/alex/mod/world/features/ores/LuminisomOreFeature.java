...
public class LuminisomOreFeature extends OreFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("pokey_alex_mod:luminisom_ore", FEATURE,
				new OreConfiguration(LuminisomOreFeatureRuleTest.INSTANCE, PokeyAlexModModBlocks.LUMINISOM_ORE.get().defaultBlockState(), 3));
		PLACED_FEATURE = PlacementUtils.register("pokey_alex_mod:luminisom_ore", CONFIGURED_FEATURE,
	...
	private static class LuminisomOreFeatureRuleTest extends RuleTest {
		...
		public static void init(FMLCommonSetupEvent event) {
			Registry.register(Registry.RULE_TEST, new ResourceLocation("pokey_alex_mod:luminisom_ore_match"), CUSTOM_MATCH);
		}

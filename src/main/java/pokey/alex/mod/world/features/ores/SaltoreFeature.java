...
public class SaltoreFeature extends OreFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("pokey_alex_mod:saltore", FEATURE,
				new OreConfiguration(SaltoreFeatureRuleTest.INSTANCE, PokeyAlexModModBlocks.SALTORE.get().defaultBlockState(), 7));
		PLACED_FEATURE = PlacementUtils.register("pokey_alex_mod:saltore", CONFIGURED_FEATURE,
	...
	private static class SaltoreFeatureRuleTest extends RuleTest {
		...
		public static void init(FMLCommonSetupEvent event) {
			Registry.register(Registry.RULE_TEST, new ResourceLocation("pokey_alex_mod:saltore_match"), CUSTOM_MATCH);
		}

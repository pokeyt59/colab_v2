...
package pokey.alex.mod.world.features.plants;
...
public class CucumberplantFeature extends RandomPatchFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("pokey_alex_mod:cucumberplant", FEATURE,
				FeatureUtils.simpleRandomPatchConfiguration(1,
						PlacementUtils.filtered(Feature.BLOCK_COLUMN,
								BlockColumnConfiguration.simple(BiasedToBottomInt.of(2, 4),
										BlockStateProvider.simple(PokeyAlexModModBlocks.CUCUMBERPLANT.get().defaultBlockState())),
								BlockPredicate.allOf(BlockPredicate.ONLY_IN_AIR_PREDICATE,
										BlockPredicate.wouldSurvive(PokeyAlexModModBlocks.CUCUMBERPLANT.get().defaultBlockState(), BlockPos.ZERO)))));
		PLACED_FEATURE = PlacementUtils.register("pokey_alex_mod:cucumberplant", CONFIGURED_FEATURE, List.of(CountPlacement.of(3),

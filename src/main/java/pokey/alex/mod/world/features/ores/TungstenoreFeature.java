...
public class TungstenoreFeature extends OreFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("pokey_alex_mod:tungstenore", FEATURE,
				new OreConfiguration(TungstenoreFeatureRuleTest.INSTANCE, PokeyAlexModModBlocks.TUNGSTENORE.get().defaultBlockState(), 7));
		PLACED_FEATURE = PlacementUtils.register("pokey_alex_mod:tungstenore", CONFIGURED_FEATURE,
				List.of(CountPlacement.of(11), InSquarePlacement.spread(),
						HeightRangePlacement.triangle(VerticalAnchor.absolute(1), VerticalAnchor.absolute(63)), BiomeFilter.biome()));
		return FEATURE;
	}
	...
	private static class TungstenoreFeatureRuleTest extends RuleTest {
		...
		public static void init(FMLCommonSetupEvent event) {
			Registry.register(Registry.RULE_TEST, new ResourceLocation("pokey_alex_mod:tungstenore_match"), CUSTOM_MATCH);
		}

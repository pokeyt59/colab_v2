...
import pokey.alex.mod.world.biome.ThecreatorsdenBiome;
import pokey.alex.mod.world.biome.ErsmBiome;
...
public class PokeyAlexModModBiomes {
	public static final DeferredRegister<Biome> REGISTRY = DeferredRegister.create(ForgeRegistries.BIOMES, PokeyAlexModMod.MODID);

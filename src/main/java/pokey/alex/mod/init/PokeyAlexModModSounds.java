...
public class PokeyAlexModModSounds {
	...
	static {
		...
		REGISTRY.put(new ResourceLocation("pokey_alex_mod", "soldier_death_sound"),
				new SoundEvent(new ResourceLocation("pokey_alex_mod", "soldier_death_sound")));
		REGISTRY.put(new ResourceLocation("pokey_alex_mod", "soldier_pain_sound"),
				new SoundEvent(new ResourceLocation("pokey_alex_mod", "soldier_pain_sound")));
	}

...
import pokey.alex.mod.fluid.LightfluidblockFluid;
...
public class PokeyAlexModModFluids {
	public static final DeferredRegister<Fluid> REGISTRY = DeferredRegister.create(ForgeRegistries.FLUIDS, PokeyAlexModMod.MODID);
